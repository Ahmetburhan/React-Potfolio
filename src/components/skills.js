...
import ios from '../assets/images/skills/ios.png';
        ...
        <section id='skills'>
            ...
            <div className="container">
                ...
                <div className="col s12 l6 skills">
                        ...
                        <div className="col s6 push-l6 skillsText">Built an <strong>iOS</strong>  app for my <a rel="noopener noreferrer" target="_blank" href="http://services.tech-loop.com/">start-up</a>. <strong>React Native</strong> was the key element along with <strong>SendGrid, Twilio and mySql</strong></div>  
                    <img className='col s3 pull-l6 ios' src={ios} alt='ios'/>
                    <img className='col s3 pull-l6 cLogo'  src={native} alt="native"/>
                </div>
